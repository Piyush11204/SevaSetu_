                    ...
                    <div className="mt-12 flex flex-col items-center">
                        ...
                        <div className="w-full flex-1 mt-8">
                            ...
                            <form className="mx-auto max-w-xs" onSubmit={handleSubmit}>
                                ...
                                <button
                                    className="mt-6 w-full py-4 rounded-lg bg-blue-600 text-white font-semibold hover:bg-blue-700 focus:outline-none"
                                    type="submit"
                                >
                                    Create Account
                                </button>
...
//     e.preventDefault();
//     try {
//         const url = "http://localhost:8080/api/users"; // Adjust the URL as necessary
//         const { data: res } = await axios.post(url, data);
//         localStorage.setItem("token", res.data);
